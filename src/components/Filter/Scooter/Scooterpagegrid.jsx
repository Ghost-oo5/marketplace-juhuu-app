  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch('https://api.juhuu.app/v1/products?categoryArray=scooter&technologyArray=digital', {
...
export default Scooterpagegrid;

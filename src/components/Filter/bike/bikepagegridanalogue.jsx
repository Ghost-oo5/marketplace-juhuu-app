...
const Bikepagegridanalogue = () => {
  ...
  const handleBuyNow = (productId) => {
    ...
    navigate(`/v1/products/Bike/${productId}`); // For Bikepagegrid.js
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://api.juhuu.app/v1/products?categoryArray=bike&technologyArray=analog', {
...
export default Bikepagegridanalogue;
